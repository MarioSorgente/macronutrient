            ...
            <>
              ...
              {preview && (
                <div className="mt-4">
                  ...
                  {/*
                    No warning strips here. Each day carries its own adherence
                    badge and names any slot it went without, which is the same
                    information where the day it applies to actually is — a
                    week-level banner only said it again, louder.
                  */}
